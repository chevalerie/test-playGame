 ...
 *  - The color number is the same as the text color in [Show text].
 *  - See img/system/Window.png for specific colors.
 *  - Add options when you want the following functions.
 *      B : Blink flag
...
(() => {
    ...
    Game_MinimapMarker._markerReg = /^(P|A|I|C(\d+)-|\!)(\d+)([BTHM]*)$/i;
    ...
    Sprite_MinimapMarker.prototype.paintMarker = function(x, y, marker) {
        ...
        switch (marker.type()) {
            ...
            case 'A':
                ...
                break;
            case 'I':
                this.paintIcon(rx, ry, marker.iconIndex(), marker.angle());
                break;
            case 'C': {
